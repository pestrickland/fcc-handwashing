    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 6, 0, 66);
    			attr_dev(div, "bp", "grid");
    			add_location(div, file, 5, 0, 50);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 14, 6, 322);
    			attr_dev(div0, "class", "progress-bar svelte-1ww4m1u");
    			set_style(div0, "width", "20%");
    			add_location(div0, file$1, 13, 4, 269);
    			attr_dev(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr_dev(div1, "class", "progress-container svelte-1ww4m1u");
    			add_location(div1, file$1, 12, 2, 204);
    			attr_dev(div2, "bp", "grid");
    			add_location(div2, file$1, 11, 0, 186);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-wmfojw");
    			add_location(h2, file$2, 16, 2, 206);
    			attr_dev(div, "bp", "grid");
    			add_location(div, file$2, 15, 0, 188);
    			attr_dev(button, "class", "start svelte-wmfojw");
    			add_location(button, file$2, 21, 0, 282);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-ygh7wu");
    			add_location(h1, file$3, 11, 0, 153);
    			attr_dev(a0, "href", "http://www.who.int/gpsc/clean_hands_protection/en/");
    			add_location(a0, file$3, 16, 0, 204);
    			attr_dev(a1, "href", "http://freesound.org/people/metrostock00/sounds/345086/");
    			add_location(a1, file$3, 17, 0, 284);
    			attr_dev(h3, "class", "svelte-ygh7wu");
    			add_location(h3, file$3, 15, 0, 199);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
